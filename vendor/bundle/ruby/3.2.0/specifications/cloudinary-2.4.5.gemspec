# -*- encoding: utf-8 -*-
# stub: cloudinary 2.4.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.required_ruby_version = Gem::Requirement.new([">= 3".freeze, "< 5".freeze])
  ...
  s.add_runtime_dependency(%q<faraday-follow_redirects>.freeze, ["~> 0.5"])
  s.add_runtime_dependency(%q<ostruct>.freeze, [">= 0"])
  s.add_development_dependency(%q<rails>.freeze, [">= 6.1.7", "< 9.0.0"])
  s.add_development_dependency(%q<rexml>.freeze, [">= 3.2.5", "< 4.0.0"])
  s.add_development_dependency(%q<actionpack>.freeze, [">= 6.1.7", "< 9.0.0"])
  ...
  s.add_development_dependency(%q<railties>.freeze, [">= 6.0.4", "< 9.0.0"])
  s.add_development_dependency(%q<rspec-rails>.freeze, [">= 6.0.4", "< 9.0.0"])
